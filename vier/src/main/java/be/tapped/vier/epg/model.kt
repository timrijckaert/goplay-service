...
public data class EpgProgram(
    ...
    val contentEpisode: String? = null,
//    @SerialName("duration")
//    val duration: Int? = null,
    @SerialName("program_node")
    val programName: ProgramNode? = null,
    @SerialName("video_node")
    val videoNode: VideoNode? = null,
)
