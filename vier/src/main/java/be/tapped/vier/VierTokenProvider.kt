...
class VierTokenProvider {
    fun login(username: String, password: String) {
        ...
        if (initAuthResult.challengeName() == ChallengeNameType.PASSWORD_VERIFIER) {
            val challengeRequest = userSrpAuthRequest(initAuthResult, password)
